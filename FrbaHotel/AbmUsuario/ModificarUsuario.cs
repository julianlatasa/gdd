...
namespace FrbaHotel.AbmUsuario
{
    public partial class ModificarUsuario : Form
    {
        ...
        private int[] obtenerRolesMarcados()
        {
            ...
            cmd.CommandText = "SELECT rol_id FROM [DON_GATO_Y_SU_PANDILLA].USUARIO_ROL WHERE usua_usuario = '" + usuario2.usuario + "'";
        ...
        private int[] obtenerHotelesMarcados()
        {
            ...
            cmd.CommandText = "SELECT hote_id FROM [DON_GATO_Y_SU_PANDILLA].USUARIO_HOTEL WHERE usua_usuario = '" + usuario2.usuario + "'";
            cmd.CommandType = CommandType.Text;
            cmd.Connection = sqlConnection;
        ...
        private bool modificarUsuario()
        {
            ...
            cmd.CommandText = "[DON_GATO_Y_SU_PANDILLA].USUARIO_Modificar";
        ...
        private void eliminarHotel(int idHotel)
        {
            ...
            cmd.CommandText = "[DON_GATO_Y_SU_PANDILLA].USUARIO_Eliminar_Hotel";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void eliminarRol(int idRol)
        {
            ...
            cmd.CommandText = "[DON_GATO_Y_SU_PANDILLA].USUARIO_Eliminar_Rol";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@usuario", SqlDbType.VarChar).Value = Conexion.usuario;
            cmd.Parameters.Add("@idRol", SqlDbType.Int).Value = idRol;
            cmd.Connection = sqlConnection;
